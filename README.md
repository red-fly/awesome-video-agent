...
<p align="center">
  ...
  <a href="./docs/zotero-2026-05-26.md">Zotero 新增</a> ·
...
当前版本共收录：**67 个核心视频 Agent 条目 + 10 个相关基础设施条目 = 77 篇论文**，另有 **6 个开源系统/工具**。

本轮额外补充了近三年正式会议/论文集条目，并整理了 2026-05-26 从 Zotero 新增的本地论文。新增代表条目包括 One Sentence, One Drama、ScriptAgent、SciEducator、StoryMem、VideoDirectorGPT、VideoGen-of-Thought、HoloCine、OneStory、InfinityStory、LongLive、Audience in the Loop、PVChat、VBench、ViStoryBench、VideoStudio 和 StoryDiffusion。完整列表见 [论文索引](./docs/paper-index.md)、[会议检索记录](./docs/proceedings-scan.md)、[Zotero 分类记录](./docs/zotero-2026-05-26.md) 和 [统计页](./docs/stats.md)。
...
| **PVChat** | 2025-10 | ICCV 2025 | 个性化视频聊天 | 通过 one-shot 个性化，让视频聊天系统用极少示例适配个人用户或身份。 | [Paper](https://openaccess.thecvf.com/content/ICCV2025/html/Shi_PVChat_Personalized_Video_Chat_with_One-Shot_Learning_ICCV_2025_paper.html) |
